...
if (isset($_POST['register'])) {
    ...
    // $lokasi = test_input($_POST['lokasi_id_lokasi'])
    $result = $koneksi->query("INSERT INTO admin(username_admin, nama, email, password) VALUES('$username', '$nama', '$email', '$password')");
            ...
            <div class="form-content flex justify-center items-center w-full h-full" >
                <div class="login-form w-11/12 pl-9">
                    <div class="welcome mb-5 text-3xl w-10/12">
                        ...
                        <div class="backlogin">
                            <a href="login-page.php" class="text-success text-sm ">Login Now</a>
                        </div>
                    </div>
